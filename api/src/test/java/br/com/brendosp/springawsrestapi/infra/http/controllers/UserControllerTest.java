...
class UserControllerTest {
    ...
    void itShouldGetUserByIdAndReturnUserWhenExistsId() {
        ...
        when(conversionService.convert(user, GetUserResponseDTO.class)).thenReturn(
        ...
        ResponseEntity<GetUserResponseDTO> response = sut.getById(userId);
        var responseBody = response.getBody();
        ...
        verify(conversionService).convert(user, GetUserResponseDTO.class);
    }
